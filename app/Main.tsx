      ...
      <div className="flex min-h-screen flex-col justify-center px-4">
        <div className="flex w-full flex-col items-start justify-between md:flex-row">
          <div className="text-left md:w-2/3">
            ...
            <p className="mt-4 text-xl leading-normal text-gray-600 dark:text-gray-400">A 💻 Developer and 🎮 Gamer</p>
            ...
            <div className="mt-8 flex space-x-4">
              <a href="mailto:example@mail.com" className="text-gray-600 dark:text-gray-400">
                Mail
              </a>
              <a href="https://mastodon.social/@Moeyy01" className="text-gray-600 dark:text-gray-400">
                Mastodon
              </a>
            </div>
          </div>
